...
def generate_launch_description():
    ...
    robotiq_85_description_package_name = "robotiq_85_description"
    robotiq_85_description_install_dir = get_package_prefix(robotiq_85_description_package_name)

    gazebo_grasp_plugin_package_name = "gazebo_grasp_plugin"
    gazebo_grasp_plugin_install_dir = get_package_prefix(gazebo_grasp_plugin_package_name)


    if 'GAZEBO_MODEL_PATH' in os.environ:
        os.environ['GAZEBO_MODEL_PATH'] = os.environ['GAZEBO_MODEL_PATH'] + ':' + install_dir + \
            '/share' +':' + mycobot_description_install_dir + '/share' + ':' + robotiq_85_description_install_dir + '/share' + ':' + gazebo_models_path
    else:
    ...
    if 'GAZEBO_PLUGIN_PATH' in os.environ:
        os.environ['GAZEBO_PLUGIN_PATH'] = os.environ['GAZEBO_PLUGIN_PATH'] + ':' + install_dir + '/lib' + ':' + \
            gazebo_plugins_name_path_install_dir + '/lib' + ':' + gazebo_grasp_plugin_install_dir + '/lib' + ':'
    else:
        os.environ['GAZEBO_PLUGIN_PATH'] = install_dir + '/lib' + ':' + gazebo_plugins_name_path_install_dir + \
            '/lib' + ':' + gazebo_grasp_plugin_install_dir + '/lib' + ':'
