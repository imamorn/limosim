...
def generate_launch_description():
    ...
    declare_x_spawn_cmd = DeclareLaunchArgument(
        name='x_spawn', default_value='0.0',
        description='X position to spawn the robot at')

    declare_y_spawn_cmd = DeclareLaunchArgument(
        name='y_spawn', default_value='0.0',
        description='Y position to spawn the robot at')

    declare_z_spawn_cmd = DeclareLaunchArgument(
        name='z_spawn', default_value='0.0',
        description='Z position to spawn the robot at')

    declare_yaw_spawn_cmd = DeclareLaunchArgument(
        name='yaw_spawn', default_value='1.57',
    ...
    ld.add_action(declare_x_spawn_cmd)
    ld.add_action(declare_y_spawn_cmd)
    ld.add_action(declare_z_spawn_cmd)
    ld.add_action(declare_yaw_spawn_cmd)
