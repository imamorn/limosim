...
def generate_launch_description():
    ...
    # Moded ackerman plugins package
    tc_gazebo_plugins_name = "tc_gazebo_plugins"
    tc_gazebo_plugins_name_path_install_dir = get_package_prefix(
        tc_gazebo_plugins_name)
    ...
    if 'GAZEBO_PLUGIN_PATH' in os.environ:
        os.environ['GAZEBO_PLUGIN_PATH'] = os.environ['GAZEBO_PLUGIN_PATH'] + ':' + install_dir + '/lib' + ':' + \
            gazebo_plugins_name_path_install_dir + '/lib' + ':' + tc_gazebo_plugins_name_path_install_dir + '/lib' + ':'
    else:
        os.environ['GAZEBO_PLUGIN_PATH'] = install_dir + '/lib' + ':' + gazebo_plugins_name_path_install_dir + \
            '/lib' + ':' + tc_gazebo_plugins_name_path_install_dir + '/lib' + ':'
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            default_value=[os.path.join(
                pkg_limo_description, 'worlds', 'basic.world'), ''],
